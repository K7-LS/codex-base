...
description: Ask one evidence-led question at a time before under-specified construction work.
---
...
1. Enter native Plan Mode when the task needs three or more dependent
   decisions.
...
Skip this workflow when inputs are demonstrably complete, the request is a
