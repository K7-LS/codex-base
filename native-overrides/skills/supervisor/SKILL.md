---
name: supervisor
description: Plan and audit explicit autonomous Codex work without bypassing permissions.
---

# supervisor

Use only when the user explicitly asks Codex to supervise background,
...
2. Use Codex task/automation monitoring already available in the current
...
5. Use the operating-system sandbox, Codex permissions and managed
